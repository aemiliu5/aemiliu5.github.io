				...
				<div id="home" className="relative flex items-center justify-center w-full h-full">
					...
					<main className={`relative text-white ${league.className} bg-[#070707] w-full h-full`}>
						<div className="flex flex-col md:flex-row justify-center">
							<div
								className="text-[32px] text-center sm:text-left sm:text-[80px] sm:px-16 sm:py-48 pt-96">
								Hello there!<br/>
							...
							<div
								className="sm:w-[600px] sm:h-[600px] mb-32 sm:py-36 sm:ml-16 sm:object-right sm:mb-64 sm:scale-100 sm:translate-y-0 relative -translate-y-[57vh] scale-75 object-center"
							>
								<Image
