...
<div className="flex flex-col md:flex-row justify-center">
							<div
								className="text-[32px] text-center sm:text-left sm:text-[64px] sm:px-16 md:px-4 sm:py-48 pt-96">
								Hello there!<br/>
								<div className="text-[32px] text-center sm:text-left sm:text-[64px] leading-[1.3] py-3">
